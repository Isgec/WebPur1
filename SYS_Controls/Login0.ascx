    ...
    <LoggedInTemplate>
      <table>
        ...
        <td>
          ...
          <asp:LoginStatus ID="LoginStatus1" runat="server" CssClass="nt-but-danger" Height="14px" Width="90px" LoginText="Sign In" LogoutAction="Redirect" LogoutPageUrl="~/Default.aspx" LogoutText="Sign Out" ToolTip="Sign Out" />
        </td>
      </table>
    </LoggedInTemplate>
  </asp:LoginView>
