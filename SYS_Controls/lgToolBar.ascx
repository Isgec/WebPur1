			...
			<td id="tdDefault" runat="server" align="left" >
				<table>
					<tr>
						...
						<td class="mnu_but">
							<asp:ImageButton ID="CmdSave" ToolTip="Save" AccessKey="S" runat="server" ImageUrl="~/TblImages/sav0.png" OnClientClick="$(':disabled', $('#form1')).removeAttr('disabled');" />
						</td>
						<td class="mnu_but">
			...
			<td id="tdPage" runat="server" align="center">
				<table>
					<tr>
						...
						<td>
							<asp:TextBox ID="_CurrentPage" runat="server" CssClass="mytxt" MaxLength="5" Width="40px" Font-Bold="True" Font-Names="vardana" Font-Size="9px" Text="1" ValidationGroup="currentpage" AutoPostBack="True" onfocus = "return this.select();" onblur="return dc(this,0);" />
						</td>
						<td class="mnu_but">
						...
						<td>
							<asp:TextBox ID="_PageSize" runat="server" CssClass="mytxt" MaxLength="5" Width="40px" Font-Bold="True" Font-Size="9px" ValidationGroup="currentpage" onfocus = "return this.select();" onblur="return dc(this,0);" />
						</td>
						<td class="mnu_but">
