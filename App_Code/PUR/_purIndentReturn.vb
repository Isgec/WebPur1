...
Namespace SIS.PUR
  ...
  Partial Public Class purIndentReturn
    ...
    Public Shared Function purIndentReturnSelectList(ByVal StartRowIndex As Integer, ByVal MaximumRows As Integer, ByVal OrderBy As String, ByVal SearchState As Boolean, ByVal SearchText As String, ByVal TranTypeID As String, ByVal DepartmentID As String, ByVal EmployeeID As String, ByVal DivisionID As String, ByVal ProjectID As String, ByVal CreatedBy As String) As List(Of SIS.PUR.purIndentReturn)
      ...
      Return Results
    End Function
    Public Shared Function purIndentReturnSelectCount(ByVal SearchState As Boolean, ByVal SearchText As String, ByVal TranTypeID As String, ByVal DepartmentID As String, ByVal EmployeeID As String, ByVal DivisionID As String, ByVal ProjectID As String, ByVal CreatedBy As String) As Integer
      Return RecordCount
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function purIndentReturnGetByID(ByVal IndentNo As Int32) As SIS.PUR.purIndentReturn
      Dim Results As SIS.PUR.purIndentReturn = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          ...
          Dim Reader As SqlDataReader = Cmd.ExecuteReader()
          If Reader.Read() Then
            Results = New SIS.PUR.purIndentReturn(Reader)
          End If
          Reader.Close()
        End Using
      End Using
    ...
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function purIndentReturnGetByID(ByVal IndentNo As Int32, ByVal Filter_TranTypeID As String, ByVal Filter_DepartmentID As String, ByVal Filter_EmployeeID As String, ByVal Filter_DivisionID As String, ByVal Filter_ProjectID As String, ByVal Filter_CreatedBy As String) As SIS.PUR.purIndentReturn
      Dim Results As SIS.PUR.purIndentReturn = SIS.PUR.purIndentReturn.purIndentReturnGetByID(IndentNo)
      Return Results
    End Function
