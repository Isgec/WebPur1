...
Namespace SIS.SPMT
  ...
  Partial Public Class spmtHSNSACCodes
    ...
    Private _dsca As String = ""
    Public Property Dsca As String
      Get
        Return _dsca
      End Get
      Set(value As String)
    ...
    Public Readonly Property DisplayField() As String
      Get
        ...
        Return _HSNSACCode & "-" & _dsca.ToString.PadRight(20, " ")
      End Get
    End Property
...
'    Autocomplete Method
    Public Shared Function SelectspmtHSNSACCodesAutoCompleteList(ByVal Prefix As String, ByVal count As Integer, ByVal contextKey As String) As String()
      ...
      If contextKey = "" Then contextKey = 0
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          ...
          SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@BillType", SqlDbType.Int, -1, contextKey)
