...
Partial Class lgMasterPage
  ...
  Private Sub LoginLine1_SignedIn(ByVal LoginID As String) Handles LoginLine1.SignedIn
  End Sub

  'Private Sub lgMasterPage_Init(sender As Object, e As EventArgs) Handles Me.Init
