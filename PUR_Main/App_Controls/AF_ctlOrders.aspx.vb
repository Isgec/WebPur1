...
Partial Class AF_ctlOrders
  ...
  Protected Sub ODSpurOrders_Inserted(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ObjectDataSourceStatusEventArgs) Handles ODSpurOrders.Inserted
    If e.Exception Is Nothing Then
      ...
      Dim str As String = New JavaScriptSerializer().Serialize(
        ...
        .msg = "",
        .OrderNo = oDC.OrderNo,
        .OrderRev = oDC.OrderRev,
        .IndentNo = IndentNo,
        .url = "../App_Edit/EF_purOrders.aspx" & tmpURL
      })
  ...
  Protected Sub FVpurOrders_PreRender(ByVal sender As Object, ByVal e As System.EventArgs) Handles FVpurOrders.PreRender
    ...
    Dim mStr As String = ""
    Dim oTR As IO.StreamReader = New IO.StreamReader(HttpContext.Current.Server.MapPath("~/PUR_Main/App_Controls") & "/AF_ctlOrders.js")
    mStr = oTR.ReadToEnd
    oTR.Close()
    oTR.Dispose()
