...
var script_purReceipts = {
    ...
    validate_SupplierID: function(sender) {
      ...
      this.validated_FK_PUR_Receipts_SupplierID_main = true;
      this.validate_FK_PUR_Receipts_SupplierID(sender,Prefix);
      },
    validate_SupplierGSTIN: function(sender) {
      var Prefix = sender.id.replace('SupplierGSTIN','');
      this.validated_FK_PUR_Receipts_SupplierGSTIN_main = true;
      this.validate_FK_PUR_Receipts_SupplierGSTIN(sender,Prefix);
      },
    validate_ApprovedBy: function(sender) {
      var Prefix = sender.id.replace('ApprovedBy','');
      this.validated_FK_PUR_Receipts_ApprovedBy_main = true;
      this.validate_FK_PUR_Receipts_ApprovedBy(sender,Prefix);
      },
    validate_ProjectID: function(sender) {
      var Prefix = sender.id.replace('ProjectID','');
      this.validated_FK_PUR_Receipts_ProjectID_main = true;
      this.validate_FK_PUR_Receipts_ProjectID(sender,Prefix);
      },
    validate_ElementID: function(sender) {
      var Prefix = sender.id.replace('ElementID','');
      this.validated_FK_PUR_Receipts_ElementID_main = true;
      this.validate_FK_PUR_Receipts_ElementID(sender,Prefix);
      },
    validate_EmployeeID: function(sender) {
      var Prefix = sender.id.replace('EmployeeID','');
      this.validated_FK_PUR_Receipts_EmployeeID_main = true;
      this.validate_FK_PUR_Receipts_EmployeeID(sender,Prefix);
      },
    validate_DepartmentID: function(sender) {
      var Prefix = sender.id.replace('DepartmentID','');
      this.validated_FK_PUR_Receipts_DepartmentID_main = true;
      this.validate_FK_PUR_Receipts_DepartmentID(sender,Prefix);
      },
    validate_CostCenterID: function(sender) {
      var Prefix = sender.id.replace('CostCenterID','');
      this.validated_FK_PUR_Receipts_CostCenterID_main = true;
      this.validate_FK_PUR_Receipts_CostCenterID(sender,Prefix);
      },
    validate_DivisionID: function(sender) {
      var Prefix = sender.id.replace('DivisionID','');
      this.validated_FK_PUR_Receipts_DivisionID_main = true;
      this.validate_FK_PUR_Receipts_DivisionID(sender,Prefix);
      },
    validate_FK_PUR_Receipts_ApprovedBy: function(o,Prefix) {
      var value = o.id;
      var ApprovedBy = $get(Prefix + 'ApprovedBy');
      if(ApprovedBy.value==''){
        if(this.validated_FK_PUR_Receipts_ApprovedBy_main){
      ...
      value = value + ',' + ApprovedBy.value ;
        ...
        PageMethods.validate_FK_PUR_Receipts_ApprovedBy(value, this.validated_FK_PUR_Receipts_ApprovedBy);
      },
    validated_FK_PUR_Receipts_ApprovedBy_main: false,
    validated_FK_PUR_Receipts_ApprovedBy: function(result) {
      var p = result.split('|');
      var o = $get(p[1]);
      if(script_purReceipts.validated_FK_PUR_Receipts_ApprovedBy_main){
    ...
    validate_FK_PUR_Receipts_DepartmentID: function(o,Prefix) {
      var value = o.id;
      var DepartmentID = $get(Prefix + 'DepartmentID');
      if(DepartmentID.value==''){
        if(this.validated_FK_PUR_Receipts_DepartmentID_main){
      ...
      value = value + ',' + DepartmentID.value ;
        ...
        o.style.backgroundRepeat= 'no-repeat';
        o.style.backgroundPosition = 'right';
        PageMethods.validate_FK_PUR_Receipts_DepartmentID(value, this.validated_FK_PUR_Receipts_DepartmentID);
      },
    validated_FK_PUR_Receipts_DepartmentID_main: false,
    validated_FK_PUR_Receipts_DepartmentID: function(result) {
      var p = result.split('|');
      var o = $get(p[1]);
      if(script_purReceipts.validated_FK_PUR_Receipts_DepartmentID_main){
        var o_d = $get(p[1]+'_Display');
        try{o_d.innerHTML = p[2];}catch(ex){}
      }
      o.style.backgroundImage  = 'none';
    ...
    validate_FK_PUR_Receipts_DivisionID: function(o,Prefix) {
      var value = o.id;
      var DivisionID = $get(Prefix + 'DivisionID');
      if(DivisionID.value==''){
        if(this.validated_FK_PUR_Receipts_DivisionID_main){
      ...
      value = value + ',' + DivisionID.value ;
        ...
        o.style.backgroundRepeat= 'no-repeat';
        o.style.backgroundPosition = 'right';
        PageMethods.validate_FK_PUR_Receipts_DivisionID(value, this.validated_FK_PUR_Receipts_DivisionID);
      },
    validated_FK_PUR_Receipts_DivisionID_main: false,
    validated_FK_PUR_Receipts_DivisionID: function(result) {
      var p = result.split('|');
      var o = $get(p[1]);
      if(script_purReceipts.validated_FK_PUR_Receipts_DivisionID_main){
        var o_d = $get(p[1]+'_Display');
        try{o_d.innerHTML = p[2];}catch(ex){}
      }
      o.style.backgroundImage  = 'none';
    ...
    validate_FK_PUR_Receipts_EmployeeID: function(o,Prefix) {
      var value = o.id;
      var EmployeeID = $get(Prefix + 'EmployeeID');
      if(EmployeeID.value==''){
        if(this.validated_FK_PUR_Receipts_EmployeeID_main){
      ...
      value = value + ',' + EmployeeID.value ;
        ...
        o.style.backgroundRepeat= 'no-repeat';
        o.style.backgroundPosition = 'right';
        PageMethods.validate_FK_PUR_Receipts_EmployeeID(value, this.validated_FK_PUR_Receipts_EmployeeID);
      },
    validated_FK_PUR_Receipts_EmployeeID_main: false,
    validated_FK_PUR_Receipts_EmployeeID: function(result) {
      var p = result.split('|');
      var o = $get(p[1]);
      if(script_purReceipts.validated_FK_PUR_Receipts_EmployeeID_main){
        var o_d = $get(p[1]+'_Display');
        try{o_d.innerHTML = p[2];}catch(ex){}
      }
      o.style.backgroundImage  = 'none';
    ...
    validate_FK_PUR_Receipts_ProjectID: function(o,Prefix) {
      var value = o.id;
      var ProjectID = $get(Prefix + 'ProjectID');
      if(ProjectID.value==''){
        if(this.validated_FK_PUR_Receipts_ProjectID_main){
      ...
      value = value + ',' + ProjectID.value ;
        ...
        o.style.backgroundRepeat= 'no-repeat';
        o.style.backgroundPosition = 'right';
        PageMethods.validate_FK_PUR_Receipts_ProjectID(value, this.validated_FK_PUR_Receipts_ProjectID);
      },
    validated_FK_PUR_Receipts_ProjectID_main: false,
    validated_FK_PUR_Receipts_ProjectID: function(result) {
      var p = result.split('|');
      var o = $get(p[1]);
      if(script_purReceipts.validated_FK_PUR_Receipts_ProjectID_main){
        var o_d = $get(p[1]+'_Display');
        try{o_d.innerHTML = p[2];}catch(ex){}
      }
      o.style.backgroundImage  = 'none';
    ...
    validate_FK_PUR_Receipts_ElementID: function(o,Prefix) {
      var value = o.id;
      var ElementID = $get(Prefix + 'ElementID');
      if(ElementID.value==''){
        if(this.validated_FK_PUR_Receipts_ElementID_main){
      ...
      value = value + ',' + ElementID.value ;
        ...
        o.style.backgroundRepeat= 'no-repeat';
        o.style.backgroundPosition = 'right';
        PageMethods.validate_FK_PUR_Receipts_ElementID(value, this.validated_FK_PUR_Receipts_ElementID);
      },
    validated_FK_PUR_Receipts_ElementID_main: false,
    validated_FK_PUR_Receipts_ElementID: function(result) {
      var p = result.split('|');
      var o = $get(p[1]);
      if(script_purReceipts.validated_FK_PUR_Receipts_ElementID_main){
        var o_d = $get(p[1]+'_Display');
        try{o_d.innerHTML = p[2];}catch(ex){}
      }
      o.style.backgroundImage  = 'none';
    ...
    validate_FK_PUR_Receipts_CostCenterID: function(o,Prefix) {
      var value = o.id;
      var CostCenterID = $get(Prefix + 'CostCenterID');
      if(CostCenterID.value==''){
        if(this.validated_FK_PUR_Receipts_CostCenterID_main){
      ...
      value = value + ',' + CostCenterID.value ;
        ...
        o.style.backgroundRepeat= 'no-repeat';
        o.style.backgroundPosition = 'right';
        PageMethods.validate_FK_PUR_Receipts_CostCenterID(value, this.validated_FK_PUR_Receipts_CostCenterID);
      },
    validated_FK_PUR_Receipts_CostCenterID_main: false,
    validated_FK_PUR_Receipts_CostCenterID: function(result) {
      var p = result.split('|');
      var o = $get(p[1]);
      if(script_purReceipts.validated_FK_PUR_Receipts_CostCenterID_main){
        var o_d = $get(p[1]+'_Display');
        try{o_d.innerHTML = p[2];}catch(ex){}
      }
      o.style.backgroundImage  = 'none';
    ...
    validate_FK_PUR_Receipts_SupplierGSTIN: function(o,Prefix) {
      var value = o.id;
      var SupplierID = $get(Prefix + 'SupplierID');
      if(SupplierID.value==''){
        if(this.validated_FK_PUR_Receipts_SupplierGSTIN_main){
      ...
      value = value + ',' + SupplierGSTIN.value ;
        ...
        o.style.backgroundRepeat= 'no-repeat';
        o.style.backgroundPosition = 'right';
        PageMethods.validate_FK_PUR_Receipts_SupplierGSTIN(value, this.validated_FK_PUR_Receipts_SupplierGSTIN);
      },
    validated_FK_PUR_Receipts_SupplierGSTIN_main: false,
    validated_FK_PUR_Receipts_SupplierGSTIN: function(result) {
      var p = result.split('|');
      var o = $get(p[1]);
      if(script_purReceipts.validated_FK_PUR_Receipts_SupplierGSTIN_main){
        var o_d = $get(p[1]+'_Display');
        try{o_d.innerHTML = p[2];}catch(ex){}
      }
      o.style.backgroundImage  = 'none';
    ...
    validate_FK_PUR_Receipts_SupplierID: function(o,Prefix) {
      var value = o.id;
      var SupplierID = $get(Prefix + 'SupplierID');
      if(SupplierID.value==''){
        if(this.validated_FK_PUR_Receipts_SupplierID_main){
          var o_d = $get(Prefix + 'SupplierID' + '_Display');
          try{o_d.innerHTML = '';}catch(ex){}
        }
        return true;
      ...
      value = value + ',' + SupplierID.value ;
        ...
        o.style.backgroundRepeat= 'no-repeat';
        o.style.backgroundPosition = 'right';
        PageMethods.validate_FK_PUR_Receipts_SupplierID(value, this.validated_FK_PUR_Receipts_SupplierID);
      },
    validated_FK_PUR_Receipts_SupplierID_main: false,
    validated_FK_PUR_Receipts_SupplierID: function(result) {
      var p = result.split('|');
      var o = $get(p[1]);
      if(script_purReceipts.validated_FK_PUR_Receipts_SupplierID_main){
        var o_d = $get(p[1]+'_Display');
        try{o_d.innerHTML = p[2];}catch(ex){}
      }
      o.style.backgroundImage  = 'none';
