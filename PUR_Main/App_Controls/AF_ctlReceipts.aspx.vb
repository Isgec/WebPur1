...
Partial Class AF_ctlReceipts
  ...
  Protected Sub ODSpurReceipts_Inserted(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ObjectDataSourceStatusEventArgs) Handles ODSpurReceipts.Inserted
    If e.Exception Is Nothing Then
      ...
      If Request.QueryString("OrderRev") IsNot Nothing Then
        OrderRev = Request.QueryString("OrderRev")
      End If
      Dim oDC As SIS.PUR.purReceipts = CType(e.ReturnValue, SIS.PUR.purReceipts)
      Dim tmpURL As String = "?tmp=1"
      tmpURL &= "&ReceiptNo=" & oDC.ReceiptNo
      Dim str As String = New JavaScriptSerializer().Serialize(
        New With {
        .err = False,
        .msg = "",
        .ReceiptNo = oDC.ReceiptNo,
        .OrderRev = OrderRev,
        .OrderNo = OrderNo,
        .url = "../App_Edit/EF_purReceipts.aspx" & tmpURL
      })
  ...
  Protected Sub FVpurReceipts_PreRender(ByVal sender As Object, ByVal e As System.EventArgs) Handles FVpurReceipts.PreRender
    ...
    Dim mStr As String = ""
    Dim oTR As IO.StreamReader = New IO.StreamReader(HttpContext.Current.Server.MapPath("~/PUR_Main/App_Controls") & "/AF_ctlReceipts.js")
    mStr = oTR.ReadToEnd
    oTR.Close()
    oTR.Dispose()
