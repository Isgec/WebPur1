<%@ Page Language="VB" MasterPageFile="~/PlaneMaster.master" AutoEventWireup="false" CodeFile="AF_ctlOrders.aspx.vb" Inherits="AF_ctlOrders" %>
      ...
      <div class="nt-col" style="width: 850px;">
        ...
        <table style="margin: auto; border: solid 1pt lightgrey">
          <tr>
            ...
            <td class="alignright">
              <b>
                <asp:Label ID="L_OrderRev" ForeColor="#CC6633" runat="server" Text="Order Rev :" /><span style="color: red">*</span></b>
            </td>
            <td>
      ...
      <tr>
        ...
        <td colspan="3">
          <asp:TextBox ID="F_PaymentTerms"
            ...
            Width="700px"
            TextMode="MultiLine" Height="35px"
            CssClass = "mytxt"
            onfocus = "return this.select();"
            onblur= "this.value=this.value.replace(/\'/g,'');"
        ...
        <td>
          ...
          <tr>
            <td colspan="4" style="text-align: right;">
              <asp:Button ID="ConverShow" runat="server" CssClass="nt-but-danger" Text="Convert and Edit Order" ValidationGroup="purOrders" CommandName="Insert" />
            </td>
          </tr>
        </table>
      </div>
