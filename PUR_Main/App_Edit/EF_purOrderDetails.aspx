<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="EF_purOrderDetails.aspx.vb" Inherits="EF_purOrderDetails" title="Edit: Order Items" %>
<asp:Content ID="CPHpurOrderDetails" ContentPlaceHolderID="cph1" runat="Server">
  ...
  <div id="div1" class="ui-widget-content page">
    <div id="div2" class="caption">
      <asp:Label ID="LabelpurOrderDetails" runat="server" Text="&nbsp;Edit: Order Items"></asp:Label>
    </div>
    <div id="div3" class="pagedata">
          ...
          <div id="frmdiv" class="ui-widget-content minipage">
            <table style="margin: auto; border: solid 1pt lightgrey">
              <tr>
                <td class="alignright">
                  <b>
                    <asp:Label ID="L_OrderNo" runat="server" ForeColor="#CC6633" Text="Order No :" /><span style="color: red">*</span></b>
                </td>
                <td>
                  <asp:TextBox
                    ID="F_OrderNo"
                ...
                <td class="alignright">
                  <b>
                    <asp:Label ID="L_OrderLine" runat="server" ForeColor="#CC6633" Text="Order Line :" /><span style="color: red">*</span></b>
                </td>
                <td>
              ...
              <tr>
                <td class="alignright">
                  <b>
                    <asp:Label ID="L_OrderRev" runat="server" ForeColor="#CC6633" Text="Order Rev :" /><span style="color: red">*</span></b>
                </td>
                <td colspan="3">
              ...
              <tr>
                <td class="alignright">
                  <asp:Label ID="L_ReceivedQuantity" runat="server" Text="Received Quantity :" />&nbsp;
                </td>
                <td>
                  <asp:TextBox ID="F_ReceivedQuantity"
                    Text='<%# Bind("ReceivedQuantity") %>'
                    ToolTip="Value of Received Quantity."
                    Enabled="False"
                    Width="184px"
                    CssClass="dmytxt"
                    Style="text-align: right"
      ...
      <asp:ObjectDataSource
        ...
        SelectMethod="purOrderDetailsGetByID"
        UpdateMethod="UZ_purOrderDetailsUpdate"
        DeleteMethod="UZ_purOrderDetailsDelete"
