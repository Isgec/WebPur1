<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="EF_purReceiptDetails.aspx.vb" Inherits="EF_purReceiptDetails" title="Edit: Receipt Items" %>
<asp:Content ID="CPHpurReceiptDetails" ContentPlaceHolderID="cph1" runat="Server">
  ...
  <div id="div1" class="ui-widget-content page">
    <div id="div2" class="caption">
      <asp:Label ID="LabelpurReceiptDetails" runat="server" Text="&nbsp;Edit: Receipt Items"></asp:Label>
    </div>
    <div id="div3" class="pagedata">
          ...
          <div id="frmdiv" class="ui-widget-content minipage">
            <table style="margin: auto; border: solid 1pt lightgrey">
              <tr>
                <td class="alignright">
                  <b>
                    <asp:Label ID="L_ReceiptNo" runat="server" ForeColor="#CC6633" Text="Receipt No :" /><span style="color: red">*</span></b>
                </td>
                <td>
                  <asp:TextBox
                    ID="F_ReceiptNo"
                ...
                <td class="alignright">
                  <b>
                    <asp:Label ID="L_ReceiptLine" runat="server" ForeColor="#CC6633" Text="Receipt Line :" /><span style="color: red">*</span></b>
                </td>
                <td>
      ...
      <asp:ObjectDataSource
        ...
        SelectMethod="purReceiptDetailsGetByID"
        UpdateMethod="UZ_purReceiptDetailsUpdate"
        DeleteMethod="UZ_purReceiptDetailsDelete"
