<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="EF_purIndentDetails.aspx.vb" Inherits="EF_purIndentDetails" title="Edit: Indent Items" %>
<asp:Content ID="CPHpurIndentDetails" ContentPlaceHolderID="cph1" runat="Server">
  ...
  <div id="div1" class="ui-widget-content page">
    <div id="div2" class="caption">
      <asp:Label ID="LabelpurIndentDetails" runat="server" Text="&nbsp;Edit: Indent Items"></asp:Label>
    </div>
    <div id="div3" class="pagedata">
          ...
          <div id="frmdiv" class="ui-widget-content minipage">
            <table style="margin: auto; border: solid 1pt lightgrey">
              <tr>
                <td class="alignright">
                  <b>
                    <asp:Label ID="L_IndentNo" runat="server" ForeColor="#CC6633" Text="Indent No :" /><span style="color: red">*</span></b>
                </td>
                <td>
                  <asp:TextBox
                    ID="F_IndentNo"
                ...
                <td class="alignright">
                  <b>
                    <asp:Label ID="L_IndentLine" runat="server" ForeColor="#CC6633" Text="Indent Line :" /><span style="color: red">*</span></b>
                </td>
                <td>
                ...
                <td colspan="4">
                  <asp:UpdatePanel runat="server">
                    <ContentTemplate>
                      ...
                      <LGM:CTL_ItemCategorySpecs ID="gvItemProperty" ItemCode='<%# Eval("ItemCode") %>' UsedFor="Indent" IndentNo='<%# Eval("IndentNo") %>' IndentLine='<%# Eval("IndentLine") %>' runat="server" />
                    </ContentTemplate>
                    <Triggers>
              ...
              <tr>
                <td class="alignright">
                  <asp:Label ID="L_OrderNo" runat="server" Text="Order No :" />&nbsp;
                </td>
                <td>
                ...
                <td class="alignright">
                  <asp:Label ID="L_OrderRev" runat="server" Text="Order Rev :" />&nbsp;
                </td>
                <td>
              ...
              <tr>
                <td class="alignright">
                  <asp:Label ID="L_OrderLine" runat="server" Text="Order Line :" />&nbsp;
                </td>
                <td>
                ...
                <td class="alignright">
                  <asp:Label ID="L_OrderedQuantity" runat="server" Text="Ordered Quantity :" />&nbsp;
                </td>
                <td>
                  <asp:TextBox ID="F_OrderedQuantity"
                    Text='<%# Bind("OrderedQuantity") %>'
                    ToolTip="Value of Ordered Quantity."
                    Enabled="False"
                    Width="184px"
                    CssClass="dmytxt"
                    Style="text-align: right"
      ...
      <asp:ObjectDataSource
        ...
        SelectMethod="purIndentDetailsGetByID"
        UpdateMethod="UZ_purIndentDetailsUpdate"
        DeleteMethod="UZ_purIndentDetailsDelete"
