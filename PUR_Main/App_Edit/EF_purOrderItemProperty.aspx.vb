...
Partial Class EF_purOrderItemProperty
  ...
  Public Property PrimaryKey() As String
    ...
    End Set
  End Property
  Protected Sub ODSpurOrderItemProperty_Selected(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ObjectDataSourceStatusEventArgs) Handles ODSpurOrderItemProperty.Selected
    Dim tmp As SIS.PUR.purOrderItemProperty = CType(e.ReturnValue, SIS.PUR.purOrderItemProperty)
  ...
  Protected Sub FVpurOrderItemProperty_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles FVpurOrderItemProperty.Init
    DataClassName = "EpurOrderItemProperty"
  ...
  Protected Sub FVpurOrderItemProperty_PreRender(ByVal sender As Object, ByVal e As System.EventArgs) Handles FVpurOrderItemProperty.PreRender
    TBLpurOrderItemProperty.EnableSave = Editable
    TBLpurOrderItemProperty.EnableDelete = Deleteable
    Dim mStr As String = ""
    Dim oTR As IO.StreamReader = New IO.StreamReader(HttpContext.Current.Server.MapPath("~/PUR_Main/App_Edit") & "/EF_purOrderItemProperty.js")
    mStr = oTR.ReadToEnd
    oTR.Close()
    oTR.Dispose()
