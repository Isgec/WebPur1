...
var script_purPendingOrders = {
    ...
    validated_FK_PUR_OrderDetails_DepartmentID: function(result) {
      var p = result.split('|');
      var o = $get(p[1]);
      if(script_purPendingOrders.validated_FK_PUR_OrderDetails_DepartmentID_main){
    ...
    validated_FK_PUR_OrderDetails_DivisionID: function(result) {
      var p = result.split('|');
      var o = $get(p[1]);
      if(script_purPendingOrders.validated_FK_PUR_OrderDetails_DivisionID_main){
        var o_d = $get(p[1]+'_Display');
        try{o_d.innerHTML = p[2];}catch(ex){}
      }
      o.style.backgroundImage  = 'none';
    ...
    validated_FK_PUR_OrderDetails_EmployeeID: function(result) {
      var p = result.split('|');
      var o = $get(p[1]);
      if(script_purPendingOrders.validated_FK_PUR_OrderDetails_EmployeeID_main){
        var o_d = $get(p[1]+'_Display');
        try{o_d.innerHTML = p[2];}catch(ex){}
      }
      o.style.backgroundImage  = 'none';
    ...
    validated_FK_PUR_OrderDetails_ProjectID: function(result) {
      var p = result.split('|');
      var o = $get(p[1]);
      if(script_purPendingOrders.validated_FK_PUR_OrderDetails_ProjectID_main){
        var o_d = $get(p[1]+'_Display');
        try{o_d.innerHTML = p[2];}catch(ex){}
      }
      o.style.backgroundImage  = 'none';
    ...
    validated_FK_PUR_OrderDetails_ElementID: function(result) {
      var p = result.split('|');
      var o = $get(p[1]);
      if(script_purPendingOrders.validated_FK_PUR_OrderDetails_ElementID_main){
        var o_d = $get(p[1]+'_Display');
        try{o_d.innerHTML = p[2];}catch(ex){}
      }
      o.style.backgroundImage  = 'none';
    ...
    validated_FK_PUR_OrderDetails_ItemCode: function(result) {
      var p = result.split('|');
      var o = $get(p[1]);
      if(script_purPendingOrders.validated_FK_PUR_OrderDetails_ItemCode_main){
        var o_d = $get(p[1]+'_Display');
        try{o_d.innerHTML = p[2];}catch(ex){}
      }
      o.style.backgroundImage  = 'none';
    ...
    validated_FK_PUR_OrderDetails_CostCenterID: function(result) {
      var p = result.split('|');
      var o = $get(p[1]);
      if(script_purPendingOrders.validated_FK_PUR_OrderDetails_CostCenterID_main){
        var o_d = $get(p[1]+'_Display');
        try{o_d.innerHTML = p[2];}catch(ex){}
      }
      o.style.backgroundImage  = 'none';
    ...
    validated_FK_PUR_OrderDetails_HSNSACCode: function(result) {
      var p = result.split('|');
      var o = $get(p[1]);
      if(script_purPendingOrders.validated_FK_PUR_OrderDetails_HSNSACCode_main){
        var o_d = $get(p[1]+'_Display');
        try{o_d.innerHTML = p[2];}catch(ex){}
      }
      o.style.backgroundImage  = 'none';
