...
Partial Class CTL_ItemCategorySpecValues
  ...
  Public Property ItemCategoryID As Integer
    Get
      Return OdsDdlpurItemCategorySpecValues.SelectParameters.Item("ItemCategoryID").DefaultValue
    End Get
    Set(value As Integer)
      OdsDdlpurItemCategorySpecValues.SelectParameters.Item("ItemCategoryID").DefaultValue = value
    End Set
  End Property
  Public Property CategorySpecID As Integer
    Get
      Return OdsDdlpurItemCategorySpecValues.SelectParameters.Item("CategorySpecID").DefaultValue
    End Get
    Set(value As Integer)
      OdsDdlpurItemCategorySpecValues.SelectParameters.Item("CategorySpecID").DefaultValue = value
    End Set
  End Property
