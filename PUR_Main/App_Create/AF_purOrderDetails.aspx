<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="AF_purOrderDetails.aspx.vb" Inherits="AF_purOrderDetails" title="Add: Order Items" %>
<asp:Content ID="CPHpurOrderDetails" ContentPlaceHolderID="cph1" runat="Server">
  ...
  <div id="div1" class="ui-widget-content page">
    <div id="div2" class="caption">
      <asp:Label ID="LabelpurOrderDetails" runat="server" Text="&nbsp;Add: Order Items"></asp:Label>
    </div>
    <div id="div3" class="pagedata">
      <LGM:ToolBar0
        ...
        runat="server" />
      <asp:FormView ID="FVpurOrderDetails"
        runat="server"
        DataKeyNames="OrderNo,OrderLine,OrderRev"
        DataSourceID="ODSpurOrderDetails"
        DefaultMode="Insert" CssClass="sis_formview">
        <InsertItemTemplate>
          <div id="frmdiv" class="ui-widget-content minipage">
            <asp:Label ID="L_ErrMsgpurOrderDetails" runat="server" ForeColor="Red" Font-Bold="true" Text=""></asp:Label>
            <table style="margin: auto; border: solid 1pt lightgrey">
              <tr>
                <td class="alignright">
                  <b>
                    <asp:Label ID="L_OrderNo" ForeColor="#CC6633" runat="server" Text="Order No :" /><span style="color: red">*</span></b>
                </td>
                <td>
                  <asp:TextBox
                    ID="F_OrderNo"
                    ...
                    ValidationGroup="purOrderDetails"
                    onblur="script_purOrderDetails.validate_OrderNo(this);"
                    runat="Server" />
                  ...
                  <AJX:AutoCompleteExtender
                    ...
                    OnClientItemSelected="script_purOrderDetails.ACEOrderNo_Selected"
                    OnClientPopulating="script_purOrderDetails.ACEOrderNo_Populating"
                    OnClientPopulated="script_purOrderDetails.ACEOrderNo_Populated"
                ...
                <td class="alignright">
                  <b>
                    <asp:Label ID="L_OrderLine" ForeColor="#CC6633" runat="server" Text="Order Line :" /><span style="color: red">*</span></b>
                </td>
                <td>
                  <asp:TextBox ID="F_OrderLine" Enabled="False" CssClass="mypktxt" Width="88px" runat="server" Text="0" />
                </td>
              </tr>
              <tr>
                <td class="alignright">
                  <b>
                    <asp:Label ID="L_OrderRev" ForeColor="#CC6633" runat="server" Text="Order Rev :" /></b>
                </td>
                <td colspan="3">
              ...
              <tr>
                ...
                <td>
                  ...
                  <asp:TextBox
                    ...
                    ClientIDMode="Static"
                    ValidationGroup="purOrderDetails"
                    onblur="script_purOrderDetails.validate_ItemCode(this);$get('showhere').click();"
                    runat="Server" />
                  <asp:Label
                  ...
                  <AJX:AutoCompleteExtender
                    ...
                    FirstRowSelected="true"
                    MinimumPrefixLength="1"
                    OnClientItemSelected="script_purOrderDetails.ACEItemCode_Selected"
                    OnClientPopulating="script_purOrderDetails.ACEItemCode_Populating"
                    OnClientPopulated="script_purOrderDetails.ACEItemCode_Populated"
                    CompletionSetCount="10"
                    CompletionListCssClass="autocomplete_completionListElement"
                    CompletionListItemCssClass="autocomplete_listItem"
                    CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"
                ...
                <td>
                  <asp:TextBox
                    ...
                    ValidationGroup="purOrderDetails"
                    onblur="script_purOrderDetails.validate_UOM(this);"
                    ClientIDMode="Static"
                    runat="Server" />
                  <asp:Label
                    ID="F_UOM_Display"
                  ...
                  <AJX:AutoCompleteExtender
                    ...
                    FirstRowSelected="true"
                    MinimumPrefixLength="1"
                    OnClientItemSelected="script_purOrderDetails.ACEUOM_Selected"
                    OnClientPopulating="script_purOrderDetails.ACEUOM_Populating"
                    OnClientPopulated="script_purOrderDetails.ACEUOM_Populated"
                    CompletionSetCount="10"
                    CompletionListCssClass="autocomplete_completionListElement"
                    CompletionListItemCssClass="autocomplete_listItem"
                    CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"
                ...
                <td colspan="4">
                  <asp:UpdatePanel runat="server">
                    <ContentTemplate>
                      ...
                      <LGM:CTL_ItemCategorySpecs ID="gvItemProperty" UsedFor="Order" runat="server" />
                    </ContentTemplate>
                    <Triggers>
              ...
              <tr>
                ...
                <td>
                  <asp:TextBox
                    ...
                    onblur="script_purOrderDetails.validate_HSNSACCode(this);"
                    runat="Server" />
                  <asp:Label
                  ...
                  <AJX:AutoCompleteExtender
                    ...
                    FirstRowSelected="true"
                    MinimumPrefixLength="1"
                    OnClientItemSelected="script_purOrderDetails.ACEHSNSACCode_Selected"
                    OnClientPopulating="script_purOrderDetails.ACEHSNSACCode_Populating"
                    OnClientPopulated="script_purOrderDetails.ACEHSNSACCode_Populated"
                    CompletionSetCount="10"
                    CompletionListCssClass="autocomplete_completionListElement"
                    CompletionListItemCssClass="autocomplete_listItem"
                    CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"
              ...
              <tr>
                ...
                <td>
                  <asp:TextBox
                    ...
                    onblur="script_purOrderDetails.validate_ProjectID(this);"
                    runat="Server" />
                  <asp:Label
                  ...
                  <AJX:AutoCompleteExtender
                    ...
                    FirstRowSelected="true"
                    MinimumPrefixLength="1"
                    OnClientItemSelected="script_purOrderDetails.ACEProjectID_Selected"
                    OnClientPopulating="script_purOrderDetails.ACEProjectID_Populating"
                    OnClientPopulated="script_purOrderDetails.ACEProjectID_Populated"
                    CompletionSetCount="10"
                    CompletionListCssClass="autocomplete_completionListElement"
                    CompletionListItemCssClass="autocomplete_listItem"
                    CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"
                ...
                <td>
                  <asp:TextBox
                    ...
                    onblur="script_purOrderDetails.validate_ElementID(this);"
                    runat="Server" />
                  <asp:Label
                  ...
                  <AJX:AutoCompleteExtender
                    ...
                    FirstRowSelected="true"
                    MinimumPrefixLength="1"
                    OnClientItemSelected="script_purOrderDetails.ACEElementID_Selected"
                    OnClientPopulating="script_purOrderDetails.ACEElementID_Populating"
                    OnClientPopulated="script_purOrderDetails.ACEElementID_Populated"
                    CompletionSetCount="10"
                    CompletionListCssClass="autocomplete_completionListElement"
                    CompletionListItemCssClass="autocomplete_listItem"
                    CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"
              ...
              <tr>
                ...
                <td>
                  <asp:TextBox
                    ...
                    onblur="script_purOrderDetails.validate_EmployeeID(this);"
                    runat="Server" />
                  <asp:Label
                  ...
                  <AJX:AutoCompleteExtender
                    ...
                    FirstRowSelected="true"
                    MinimumPrefixLength="1"
                    OnClientItemSelected="script_purOrderDetails.ACEEmployeeID_Selected"
                    OnClientPopulating="script_purOrderDetails.ACEEmployeeID_Populating"
                    OnClientPopulated="script_purOrderDetails.ACEEmployeeID_Populated"
                    CompletionSetCount="10"
                    CompletionListCssClass="autocomplete_completionListElement"
                    CompletionListItemCssClass="autocomplete_listItem"
                    CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"
                ...
                <td>
                  <asp:TextBox
                    ...
                    onblur="script_purOrderDetails.validate_DepartmentID(this);"
                    runat="Server" />
                  <asp:Label
                  ...
                  <AJX:AutoCompleteExtender
                    ...
                    FirstRowSelected="true"
                    MinimumPrefixLength="1"
                    OnClientItemSelected="script_purOrderDetails.ACEDepartmentID_Selected"
                    OnClientPopulating="script_purOrderDetails.ACEDepartmentID_Populating"
                    OnClientPopulated="script_purOrderDetails.ACEDepartmentID_Populated"
                    CompletionSetCount="10"
                    CompletionListCssClass="autocomplete_completionListElement"
                    CompletionListItemCssClass="autocomplete_listItem"
                    CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"
              ...
              <tr>
                ...
                <td>
                  <asp:TextBox
                    ...
                    onblur="script_purOrderDetails.validate_CostCenterID(this);"
                    runat="Server" />
                  <asp:Label
                  ...
                  <AJX:AutoCompleteExtender
                    ...
                    FirstRowSelected="true"
                    MinimumPrefixLength="1"
                    OnClientItemSelected="script_purOrderDetails.ACECostCenterID_Selected"
                    OnClientPopulating="script_purOrderDetails.ACECostCenterID_Populating"
                    OnClientPopulated="script_purOrderDetails.ACECostCenterID_Populated"
                    CompletionSetCount="10"
                    CompletionListCssClass="autocomplete_completionListElement"
                    CompletionListItemCssClass="autocomplete_listItem"
                    CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"
                ...
                <td>
                  <asp:TextBox
                    ...
                    onblur="script_purOrderDetails.validate_DivisionID(this);"
                    runat="Server" />
                  <asp:Label
                  ...
                  <AJX:AutoCompleteExtender
                    ...
                    FirstRowSelected="true"
                    MinimumPrefixLength="1"
                    OnClientItemSelected="script_purOrderDetails.ACEDivisionID_Selected"
                    OnClientPopulating="script_purOrderDetails.ACEDivisionID_Populating"
                    OnClientPopulated="script_purOrderDetails.ACEDivisionID_Populated"
                    CompletionSetCount="10"
                    CompletionListCssClass="autocomplete_completionListElement"
                    CompletionListItemCssClass="autocomplete_listItem"
                    CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"
      ...
      <asp:ObjectDataSource
        ...
        InsertMethod="UZ_purOrderDetailsInsert"
