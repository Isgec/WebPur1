<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="AF_purReceipts.aspx.vb" Inherits="AF_purReceipts" title="Add: Receipts" %>
<asp:Content ID="CPHpurReceipts" ContentPlaceHolderID="cph1" runat="Server">
  <div id="div1" class="ui-widget-content page">
    <div id="div2" class="caption">
      <asp:Label ID="LabelpurReceipts" runat="server" Text="&nbsp;Add: Receipts"></asp:Label>
    </div>
      ...
      <asp:UpdatePanel ID="UPNLpurReceipts" runat="server">
        <ContentTemplate>
          <LGM:ToolBar0
            ...
            ToolType="lgNMAdd"
            InsertAndStay="False"
            AfterInsertURL="~/PUR_Main/App_Edit/EF_purReceipts.aspx"
