<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="AF_purAprTypEmpLimit.aspx.vb" Inherits="AF_purAprTypEmpLimit" title="Add: Approver Limit" %>
<asp:Content ID="CPHpurAprTypEmpLimit" ContentPlaceHolderID="cph1" Runat="Server">
<div id="div1" class="ui-widget-content page">
<div id="div2" class="caption">
    <asp:Label ID="LabelpurAprTypEmpLimit" runat="server" Text="&nbsp;Add: Approver Limit"></asp:Label>
</div>
...
<asp:FormView ID="FVpurAprTypEmpLimit"
  ...
  <InsertItemTemplate>
    ...
    <asp:Label ID="L_ErrMsgpurAprTypEmpLimit" runat="server" ForeColor="Red" Font-Bold="true" Text=""></asp:Label>
...
<asp:ObjectDataSource 
  ...
  InsertMethod="purAprTypEmpLimitInsert"
